...
namespace Dreamteck.Splines
{
    public static class SplineEditorHandles
    {
        ...
        public static bool Slider(SplineUser user, ref double percent, Color color, string text = "", SplineSliderGizmo gizmo = SplineSliderGizmo.Rectangle, float buttonSize = 1f)
        {
            ...
            var fmh_77_71_638605538799739922 = Quaternion.LookRotation(cam.transform.position - result.position); result.position = Handles.FreeMoveHandle(result.position, size * 0.2f * buttonSize, Vector3.zero, Handles.CircleHandleCap);
#else
        ...
        {
#if UNITY_5_5_OR_NEWER
           var fmh_134_52_638605538799800241 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.RectangleHandleCap);
#else
        ...
        {
#if UNITY_5_5_OR_NEWER
            var fmh_143_53_638605538799808686 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
#else
